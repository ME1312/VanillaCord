            ...
            return new MethodVisitor(ASM9, super.visitMethod(access, name, descriptor, signature, exceptions)) {
                ...
                public void visitLabel(Label label) {
                    ...
                    if (state == 0) {
                        ...
                        mv.visitJumpInsn(IFEQ, this.label);
                        state = 1;
                    }
                }
                ...
                public void visitLdcInsn(Object value) {
                    if (state == 1 && "Payload may not be larger than 1048576 bytes".equals(value)) {
                        state = 2;
                    }
                ...
                public void visitVarInsn(int opcode, int index) {
                    if (state == 2 && opcode == ALOAD && index == 0) {
                ...
                public void visitMethodInsn(int opcode, String owner, String name, String descriptor, boolean isInterface) {
                    if (state == 3 && opcode == INVOKEVIRTUAL && descriptor.startsWith("(I)")) {
                        mv.visitMethodInsn(INVOKEVIRTUAL,
                                owner,
                                "readBytes",
                ...
                public void visitEnd() {
                    super.visitEnd();
                    if (state < 4) throw new IllegalStateException("Rewrite failed: 0x0" + state);
                }
            };
        }
